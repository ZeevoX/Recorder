...
public class AboutActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    openSourceLicencesText.setOnClickListener(
  ...
  private void dialogLicences() {
    ...
    //Licences dialog, for more information, see https://github.com/PSDev/LicensesDialog
    final Notices notices = new Notices();
    notices.addNotice(
        new Notice(
            "Recorder",
            "https://play.google.com/store/apps/details?id=com.zeevox.recorder",
            "Copyright (c) 2016-2017 Timothy \"ZeevoX\" Langer",
            new MITLicense()));
    notices.addNotice(
        new Notice(
            "MaterialDialogs API",
