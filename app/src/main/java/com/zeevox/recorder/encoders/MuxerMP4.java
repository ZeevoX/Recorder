...
////
////    static Map<String, MediaCodecInfo> findEncoder() {
////        Map<String, MediaCodecInfo> map = new HashMap<>();
////
////        "audio/mp4" = "audio/mp4".toLowerCase();
////
...
////    }
////
////    static MediaFormat getDefault(Map<String, MediaCodecInfo> map) {
////        String p = prefered("audio/mp4a-latm", map);
